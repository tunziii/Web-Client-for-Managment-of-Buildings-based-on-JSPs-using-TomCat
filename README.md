...
-> Navigate to the Apache TomCat folder
-> Navigate to the folder "webapps" (...\apache-tomcat-11.0.22\webapps)
-> Download the "Buildings" folder and paste it in the folder "webapps"

To Start the Building Manager:
